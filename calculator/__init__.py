...
def calc_ex1():
    ...
    if abs(float(out) - 4.000000) > 0.00001:
        raise check50.Mismatch(str(4.000000), out.strip(), help='Answer should be within 0.00001 of the expected value')
...
def calc_ex2():
    ...
    if abs(float(out) - -17.379999) > 0.00001:
        raise check50.Mismatch(str(-17.379999), out.strip(), help='Answer should be within 0.00001 of the expected value')
...
def calc_ex3():
    ...
    if abs(float(out) - 50.000000) > 0.00001:
        raise check50.Mismatch(str(50.000000), out.strip(), help='Answer should be within 0.00001 of the expected value')
