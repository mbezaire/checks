 ...
 * Ver 1.0 Created 12/31/17
 ...
 Updated by Dr B - for testing TestBalloon with no graphics/x in regular IDE
 */
...
class Graphics
{
  ...
  public void fillOval(int x, int y, int z, int a)
  { }

  public void drawOval(int x, int y, int z, int a)
  { }
}