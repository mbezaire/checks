...
def jorge():
    ...
    if not isinstance(inspect.getattr(days.AHSDay, "days_meet"), classmethod): # inspect.ismethod(days.AHSDay.days_meet): #isinstance(inspect.getattr(days.AHSDay, "days_meet"), classmethod): # import inspect first
