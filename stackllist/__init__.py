...
def exists():
    """stackllist.c exists"""
    check50.exists("stackllist.c")

@check50.check(exists)
def compiles():
    """stackllist.c compiles - other checks will occur manually"""
    check50.c.compile("stackllist.c", lcs50=True)

#@check50.check(compiles)
#def short_phrase():
#    """The linked list pushes and pops correctly"""
#    err_null = False
#    try:
